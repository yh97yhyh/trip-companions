...
extension Member {
    ...
    static let MOCK_MEMBER2: Member = .init(id: 1, loginId: "member2", age: 27, name: "김피아", nickName: "Phia", phoneNumber: "010-1234-1234", email: "member1@test.com", tokenKey: "test", mbti: MBTI.MOCK_MBTIS[1], gender: Gender.MOCK_GENDERS[1], isSmoking: true, isDrinking: true, interestRegion: Region.MOCK_REGIONS[0], isLogin: false, isDelete: false)
